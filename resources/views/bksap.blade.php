...
<html lang="en">
  ...
  <head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/remixicon/3.5.0/remixicon.css" rel="stylesheet" crossorigin="">
    ...
    <section class="container">
      ...
      <div class="modern-wewenang">
        <div class="modern-card">
          <div class="content">
            <h4>Mengembangkan, membina, dan meningkatkan hubungan persahabatan dan kerja sama antara SM FH Undip dan parlemen lain, baik secara bilateral maupun
              multilateral, termasuk organisasi nasional</h4>
          </div>
        </div>
        <div class="modern-card">
          <div class="content">
