...
@section("content")
  ...
  <body>
    ...
    <form class="custom-form" action="{{ route("admin.jdih.update", ["id" => $jdihRecord->id]) }}" method="POST" enctype="multipart/form-data">
      ...
      <label for="file_peraturan">File Peraturan<small style="font-size: 0.8em;">(centang jika ingin menghapus file)</small>:</label><br>
      @if ($jdihRecord->file_peraturan)
        ...
        <input type="checkbox" name="file_peraturan_delete" value="1"> <br>
      @endif
      <input accept=".doc, .docx, application/pdf" class="custom-bae" id="file_peraturan" name="file_peraturan" type="file"><br>

      <label for="file_naskah">File Naskah Akademik<small style="font-size: 0.8em;">(centang jika ingin menghapus file)</small>:</label><br>
      @if ($jdihRecord->file_naskah)
        ...
        <input type="checkbox" name="file_naskah_delete" value="1"> <br>
      @endif
      <input accept=".doc, .docx, application/pdf" class="custom-bae" id="file_naskah" name="file_naskah" type="file"><br>

      <label for="file_inventarisasi">File DIM<small style="font-size: 0.8em;">(centang jika ingin menghapus file)</small>:</label><br>
      @if ($jdihRecord->file_inventarisasi)
        ...
        <input type="checkbox" name="file_inventarisasi_delete" value="1"> <br>
      @endif
