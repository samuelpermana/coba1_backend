...
<body>
    ...
    <section class="container">
        <h1 class="j-header4">KOMISI EMPAT</h1>
            ...
            <div class="slide">
                ...
                <div class="item" style="background-image: url(https://images6.alphacoders.com/439/439546.jpg);">
                    <div class="content">
                        ...
                        <div class="des">Komisi 4 adalah komisi yang menaungi terkait Bidang Advokasi, Akademik, Sarana, dan Prasarana. Komisi empat berkoordinasi dan bertanggung jawab kepada mitra kerjanya, yaitu : BEM Bidang KAPRO dan ADVOKESMA</div>
    ...
    <section class="container-k">
        <h2 class="header">Agenda Kerja</h2>
            <div class="tag-divide">
                ...
                <div class="panel-k">
                    <div class="agenda">
                        ...
                        <p>
                            Perubahan Peraturan dalam Peminjaman Ruangan di Website SM FH UNDIP 2024
                        </p>
                    </div>
                    <div class="check">
                        <div class="title-k">
                    ...
                    <div class="file">
                        ...
                        <div class="container-img">
                            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-file-pdf" viewBox="0 0 16 16">
                            ...
                            <button class="d-btn">Download File</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="tag-divide">
                <button class="accordion-k">Agenda 2</button>
                <div class="panel-k">
                    <div class="agenda">
                        <h2 class="title-k">Agenda</h2>
                        <p>
            ...
            <div class="tag-divide">
                <button class="accordion-k">Agenda 3</button>
                <div class="panel-k">
                    <div class="agenda">
                        <h2 class="title-k">Agenda</h2>
                        <p>
            ...
            <div class="tag-divide">
                <button class="accordion-k">Agenda 4</button>
                <div class="panel-k">
                    <div class="agenda">
                        <h2 class="title-k">Agenda</h2>
                        <p>
            ...
            <div class="tag-divide">
                <button class="accordion-k">Agenda 5</button>
                <div class="panel-k">
                    <div class="agenda">
                        <h2 class="title-k">Agenda</h2>
                        <p>
